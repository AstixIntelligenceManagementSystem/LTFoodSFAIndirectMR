...
public class LastVisitDetails extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		TextView txt_outStandingAmt= (TextView)findViewById(R.id.txt_outStandingAmt);
		    ...
		    */
			...
			dbengine.close();
			storeName.setText(selStoreName.split(Pattern.quote("^"))[0]+" "+"Summary");
		txt_outStandingAmt.setText("Rs.  "+selStoreName.split(Pattern.quote("^"))[1]);
...
final Button btn_Cancel=(Button) findViewById(R.id.btn_Cancel);
		...
		btn_Cancel.setOnClickListener(new OnClickListener() {
		    //  wer
		     ...
		     alertDialogSyncError.setMessage("Are you sure to cancel the visit of the dealer?");
		...
		visitDate_butn.setOnClickListener(new OnClickListener(
			...
			else
			{
                ...
                alertDialogBuilder.setMessage("There is no Data Available For Visit/Order");
    ...
    tbl3_dyntable_SpecialSchemeApplicable = (TableLayout) findViewById(R.id.dyntable_SpecialSchemeApplicable);
		...
		nxtP4.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0)
			{
				...
				//surbhi
				Intent nxtP4 = new Intent(LastVisitDetails.this,BusinessUnitActivity.class);
				nxtP4.putExtra("storeID", storeID);
				startActivity(nxtP4);
				finish();
				...
				//flgGSTCompliance="1";
				 if(flgGSTCompliance.equals("1"))
				 {
					 final AlertDialog builder = new AlertDialog.Builder(LastVisitDetails.this).create();
						...
						//cancel.setVisibility(View.GONE);
				     	header_text.setText("Alert");
				     	msg.setText("Enter GST Number");
				     	
				     	ok_but.setText("Confirm");
				        ...
				        ok_but.setOnClickListener(new OnClickListener() 
				        {
							...
							public void onClick(View arg0) 
							{
								...
								if(ok_but.getText().toString().trim().equals("Confirm"))
								{
									...
									{
										msg.setText(("Please enter GST Number to proceed"));
										cancel.setVisibility(View.GONE);
