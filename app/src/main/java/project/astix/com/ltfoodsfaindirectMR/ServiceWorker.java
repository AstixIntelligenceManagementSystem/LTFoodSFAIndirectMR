...
public class ServiceWorker 
{
	...
	public ServiceWorker getallStores(Context ctx, String dateVAL, String uuid, String rID)
	{
		this.context = ctx;
		...
		dbengine.Delete_TemplateCategoryTables();
		dbengine.deleteAllMRMstrTables();

//MRGetStoreForDay
		//GetStoreListMR
		final String SOAP_ACTION = "http://tempuri.org/fnMRGetStoreForDay";
		final String METHOD_NAME = "fnMRGetStoreForDay";
		...
		try
		{
			...
			for (int i = 0; i < tblUOMMstrNode.getLength(); i++)
			{
				...
				String collectionRequired="0.00";


				String StoreIDPDAFromServer="NA";
				int flgOnSpotLocation=0;
				int Distance=1000000;
				int flgTakeOrder=0;
				int flgDisplayNonCatPaid=0;
				int flgHasBrandElements=0;
				String mrChainTypeID="0";
				String mrChainType="";
				String mrChainName="";
				...
				if(!element.getElementsByTagName("CollectionReq").equals(null))
				{

					NodeList CollectionReqNode = element.getElementsByTagName("CollectionReq");
					Element     line = (Element) CollectionReqNode.item(0);

					if(CollectionReqNode.getLength()>0)
					{

						collectionRequired=xmlParser.getCharacterDataFromElement(line);
					}
				}

				if(!element.getElementsByTagName("flgOnSpotLocation").equals(null))
				{

					NodeList flgOnSpotLocationNode = element.getElementsByTagName("flgOnSpotLocation");
					Element     line = (Element) flgOnSpotLocationNode.item(0);

					if(flgOnSpotLocationNode.getLength()>0)
					{

						flgOnSpotLocation=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}

				if(!element.getElementsByTagName("Distance").equals(null))
				{

					NodeList DistanceNode = element.getElementsByTagName("Distance");
					Element     line = (Element) DistanceNode.item(0);

					if(DistanceNode.getLength()>0)
					{

						Distance=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}

				if(!element.getElementsByTagName("flgTakeOrder").equals(null))
				{

					NodeList flgTakeOrderNode = element.getElementsByTagName("flgTakeOrder");
					Element     line = (Element) flgTakeOrderNode.item(0);

					if(flgTakeOrderNode.getLength()>0)
					{

						flgTakeOrder=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}

				if(!element.getElementsByTagName("flgDisplayNonCatPaid").equals(null))
				{

					NodeList flgDisplayNonCatPaidNode = element.getElementsByTagName("flgDisplayNonCatPaid");
					Element     line = (Element) flgDisplayNonCatPaidNode.item(0);

					if(flgDisplayNonCatPaidNode.getLength()>0)
					{

						flgDisplayNonCatPaid=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}



				if(!element.getElementsByTagName("flgHasBrandElements").equals(null))
				{

					NodeList flgHasBrandElementsNode = element.getElementsByTagName("flgHasBrandElements");
					Element     line = (Element) flgHasBrandElementsNode.item(0);

					if(flgHasBrandElementsNode.getLength()>0)
					{

						flgHasBrandElements=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}
				if(!element.getElementsByTagName("MRChainTypeID").equals(null))
				{

					NodeList MRChainTypeIDNode = element.getElementsByTagName("MRChainTypeID");
					Element     line = (Element) MRChainTypeIDNode.item(0);

					if(MRChainTypeIDNode.getLength()>0)
					{

						mrChainTypeID=xmlParser.getCharacterDataFromElement(line);
					}
				}
				if(!element.getElementsByTagName("MRChainType").equals(null))
				{

					NodeList MRChainTypeNode = element.getElementsByTagName("MRChainType");
					Element     line = (Element) MRChainTypeNode.item(0);

					if(MRChainTypeNode.getLength()>0)
					{

						mrChainType=xmlParser.getCharacterDataFromElement(line);
					}
				}
				if(!element.getElementsByTagName("MRChainName").equals(null))
				{

					NodeList MRChainNameNode = element.getElementsByTagName("MRChainName");
					Element     line = (Element) MRChainNameNode.item(0);

					if(MRChainNameNode.getLength()>0)
					{

						mrChainName=xmlParser.getCharacterDataFromElement(line);
					}
				}
			...
			NodeList tblCategoryMasterNode = doc.getElementsByTagName("tblCategoryMaster");
			for (int i = 0; i < tblCategoryMasterNode.getLength(); i++)
			{
				String BusinessUnitId="0";
				String BusinessUnitNodeType="0";
				String BusinessUnit="0";
				int flgCompltStatus=0;

				Element element = (Element) tblCategoryMasterNode.item(i);
				...
				if(!element.getElementsByTagName("BusinessUnitNodeType").equals(null))
				{
					NodeList BusinessUnitNodeTypeNode = element.getElementsByTagName("BusinessUnitNodeType");
					Element     line = (Element) BusinessUnitNodeTypeNode.item(0);
					if(BusinessUnitNodeTypeNode.getLength()>0)
					{
						BusinessUnitNodeType=xmlParser.getCharacterDataFromElement(line);
					}
				}
				...
				dbengine.savetblCategoryMstrData(BusinessUnitId,BusinessUnitNodeType,BusinessUnit,flgCompltStatus);
				System.out.println("DISPLAY CATEGORY MSTR: "+BusinessUnitId+"-"+BusinessUnitNodeType+"-"+BusinessUnit);
			}

			NodeList tblDisplayTabMasterNode = doc.getElementsByTagName("tblDisplayTabMaster");
			for (int i = 0; i < tblDisplayTabMasterNode.getLength(); i++)
			{
				String DisplayCategoryID="0";
				String DisplayCategory="0";

				Element element = (Element) tblDisplayTabMasterNode.item(i);

				if(!element.getElementsByTagName("DisplayCategoryID").equals(null))
				{
					NodeList DisplayCategoryIDNode = element.getElementsByTagName("DisplayCategoryID");
					Element     line = (Element) DisplayCategoryIDNode.item(0);
					if(DisplayCategoryIDNode.getLength()>0)
					{
						DisplayCategoryID=xmlParser.getCharacterDataFromElement(line);
					}
				}
				if(!element.getElementsByTagName("DisplayCategory").equals(null))
				{
					NodeList DisplayCategoryNode = element.getElementsByTagName("DisplayCategory");
					Element     line = (Element) DisplayCategoryNode.item(0);
					if(DisplayCategoryNode.getLength()>0)
					{
						DisplayCategory=xmlParser.getCharacterDataFromElement(line);
					}
				}

				dbengine.savetblDisplayTabMasterData(DisplayCategoryID,DisplayCategory);
				System.out.println("DISPLAY TAB MSTR: "+DisplayCategoryID+"-"+DisplayCategory);
			}

			NodeList tblDisplayTypeMasterNode = doc.getElementsByTagName("tblDisplayTypeMaster");
			for (int i = 0; i < tblDisplayTypeMasterNode.getLength(); i++)
			{
				String DisplayTypeID="0";
				String DisplayName="0";

				Element element = (Element) tblDisplayTypeMasterNode.item(i);

				if(!element.getElementsByTagName("DisplayTypeID").equals(null))
				{
					NodeList DisplayTypeIDNode = element.getElementsByTagName("DisplayTypeID");
					Element     line = (Element) DisplayTypeIDNode.item(0);
					if(DisplayTypeIDNode.getLength()>0)
					{
						DisplayTypeID=xmlParser.getCharacterDataFromElement(line);
					}
				}
				if(!element.getElementsByTagName("DisplayName").equals(null))
				{
					NodeList DisplayNameNode = element.getElementsByTagName("DisplayName");
					Element     line = (Element) DisplayNameNode.item(0);
					if(DisplayNameNode.getLength()>0)
					{
						DisplayName=xmlParser.getCharacterDataFromElement(line);
					}
				}

				dbengine.savetblDisplayTypeMasterData(DisplayTypeID,DisplayName);
				System.out.println("DISPLAY TYPE MSTR: "+DisplayTypeID+"-"+DisplayName);
			}

			NodeList tblTemplateMasterNode = doc.getElementsByTagName("tblTemplateMaster");
			for (int i = 0; i < tblDisplayTypeMasterNode.getLength(); i++)
			{
				String TemplateID="0";
				String TemplateDesc="0";

				Element element = (Element) tblTemplateMasterNode.item(i);

				if(!element.getElementsByTagName("TemplateID").equals(null))
				{
					NodeList TemplateIDNode = element.getElementsByTagName("TemplateID");
					Element     line = (Element) TemplateIDNode.item(0);
					if(TemplateIDNode.getLength()>0)
					{
						TemplateID=xmlParser.getCharacterDataFromElement(line);
					}
				}
				if(!element.getElementsByTagName("TemplateDesc").equals(null))
				{
					NodeList TemplateDescNode = element.getElementsByTagName("TemplateDesc");
					Element     line = (Element) TemplateDescNode.item(0);
					if(TemplateDescNode.getLength()>0)
					{
						TemplateDesc=xmlParser.getCharacterDataFromElement(line);
					}
				}

				dbengine.savetblTemplateMasterData(TemplateID,TemplateDesc);
				System.out.println("DISPLAY TEMP MSTR: "+TemplateID+"-"+TemplateDesc);
			}

			NodeList tblDisplayLocMasterNode = doc.getElementsByTagName("tblDisplayLocMaster");
			for (int i = 0; i < tblDisplayLocMasterNode.getLength(); i++)
			{
				String DisplayLocationID="0";
				String DisplayLocation="0";

				Element element = (Element) tblDisplayLocMasterNode.item(i);

				if(!element.getElementsByTagName("DisplayLocationID").equals(null))
				{
					NodeList DisplayLocationIDNode = element.getElementsByTagName("DisplayLocationID");
					Element     line = (Element) DisplayLocationIDNode.item(0);
					if(DisplayLocationIDNode.getLength()>0)
					{
						DisplayLocationID=xmlParser.getCharacterDataFromElement(line);
					}
				}
				if(!element.getElementsByTagName("DisplayLocation").equals(null))
				{
					NodeList DisplayLocationNode = element.getElementsByTagName("DisplayLocation");
					Element     line = (Element) DisplayLocationNode.item(0);
					if(DisplayLocationNode.getLength()>0)
					{
						DisplayLocation=xmlParser.getCharacterDataFromElement(line);
					}
				}

				dbengine.savetblDisplayLocMasterData(DisplayLocationID,DisplayLocation);
				System.out.println("DISPLAY LOC MSTR: "+DisplayLocationID+"-"+DisplayLocation);
			}

			NodeList tblDisplayTypeTemplateMappingNode = doc.getElementsByTagName("tblDisplayTypeTemplateMapping");
			for (int i = 0; i < tblDisplayTypeTemplateMappingNode.getLength(); i++)
			{
				String StoreID="0";
				String BusinessUnitId="0";
				String BusinessUnitNodeType="0";
				String DisplayTypeID="0";
				String flgAddDisplayItem="0";
				String DisplayCategoryID="0";
				String TemplateID="0";
				int RowID=0;
				String dsplayLocId="0";
				int flgInnerOuterAdditionalDisplay=0;

				Element element = (Element) tblDisplayTypeTemplateMappingNode.item(i);
				...
				if(!element.getElementsByTagName("flgAddDisplayItem").equals(null))
				{
					NodeList flgAddDisplayItemNode = element.getElementsByTagName("flgAddDisplayItem");
					Element     line = (Element) flgAddDisplayItemNode.item(0);
					if(flgAddDisplayItemNode.getLength()>0)
					{
						flgAddDisplayItem=xmlParser.getCharacterDataFromElement(line);
					}
				}
				if(!element.getElementsByTagName("DisplayCategoryID").equals(null))
				{
				...
				if(!element.getElementsByTagName("RowID").equals(null))
				{
					NodeList RowIDNode = element.getElementsByTagName("RowID");
					Element     line = (Element) RowIDNode.item(0);
					if(RowIDNode.getLength()>0)
					{
						RowID=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}
				...
				if(!element.getElementsByTagName("DisplayLocationID").equals(null))
				{
					...
					if(DisplayLocationIDNode.getLength()>0)
					{
						dsplayLocId=xmlParser.getCharacterDataFromElement(line);
					}
				}

				if(!element.getElementsByTagName("flgInnerOuterAdditionalDisplay").equals(null))
				{
					NodeList flgInnerOuterAdditionalDisplayNode = element.getElementsByTagName("flgInnerOuterAdditionalDisplay");
					Element     line = (Element) flgInnerOuterAdditionalDisplayNode.item(0);
					if(flgInnerOuterAdditionalDisplayNode.getLength()>0)
					{
						flgInnerOuterAdditionalDisplay=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}

				dbengine.savetblDisplayTypeTemplateMappingData(StoreID,BusinessUnitId,BusinessUnitNodeType,DisplayTypeID,flgAddDisplayItem,
						DisplayCategoryID,TemplateID,RowID,dsplayLocId,flgInnerOuterAdditionalDisplay);
			/*	System.out.println("DISPLAY TYPE TEMP MAP: "+StoreID+"-"+BusinessUnitId+"-"+BusinessUnitNodeType+"-"+DisplayTypeID +"-"+
								flgAddDisplayItem+"-"+DisplayCategoryID+"-"+TemplateID);*/
			}


			NodeList tblGetMRProuctBussinessMstrNode = doc.getElementsByTagName("tblMRProuctBussinessMstr");
			for (int i = 0; i < tblGetMRProuctBussinessMstrNode.getLength(); i++)
			{

				//int ProductID=0;
				int WeightCategoryID=0;
				String WeightCategory="0";
				int BrandID=0;
				String BrandName="0";
				int CategoryID=0;
				String CategoryName="0";
				//int BussinessUnitID=0;
				//int flgCompanyProdOrOther=0;
				int Sequence=0;


				Element element = (Element) tblGetMRProuctBussinessMstrNode.item(i);
				...
				if(!element.getElementsByTagName("WeightCategoryID").equals(null))
				{

					NodeList WeightCategoryIDNode = element.getElementsByTagName("WeightCategoryID");
					Element     line = (Element) WeightCategoryIDNode.item(0);

					if(WeightCategoryIDNode.getLength()>0)
					{

						WeightCategoryID=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}
				...
				if(!element.getElementsByTagName("WeightCategory").equals(null))
				{

					NodeList WeightCategoryNode = element.getElementsByTagName("WeightCategory");
					Element     line = (Element) WeightCategoryNode.item(0);

					if(WeightCategoryNode.getLength()>0)
					{

						WeightCategory=xmlParser.getCharacterDataFromElement(line);
					}
				}

				if(!element.getElementsByTagName("BrandID").equals(null))
				{

					NodeList BrandIDNode = element.getElementsByTagName("BrandID");
					Element     line = (Element) BrandIDNode.item(0);

					if(BrandIDNode.getLength()>0)
					{

						BrandID=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}

				if(!element.getElementsByTagName("BrandName").equals(null))
				{

					NodeList BrandNameNode = element.getElementsByTagName("BrandName");
					Element     line = (Element) BrandNameNode.item(0);

					if(BrandNameNode.getLength()>0)
					{

						BrandName=xmlParser.getCharacterDataFromElement(line);
					}
				}
				...
				if(!element.getElementsByTagName("CategoryName").equals(null))
				{

					NodeList CategoryNameNode = element.getElementsByTagName("CategoryName");
					Element     line = (Element) CategoryNameNode.item(0);

					if(CategoryNameNode.getLength()>0)
					{

						CategoryName=xmlParser.getCharacterDataFromElement(line);
					}
				}

				/*if(!element.getElementsByTagName("BussinessUnitID").equals(null))
				{

					NodeList BussinessUnitIDNode = element.getElementsByTagName("BussinessUnitID");
					Element     line = (Element) BussinessUnitIDNode.item(0);

					if(BussinessUnitIDNode.getLength()>0)
					{

						BussinessUnitID=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}*/

				/*if(!element.getElementsByTagName("flgCompanyProdOrOther").equals(null))
				{

					NodeList flgCompanyProdOrOtherNode = element.getElementsByTagName("flgCompanyProdOrOther");
					Element     line = (Element) flgCompanyProdOrOtherNode.item(0);

					if(flgCompanyProdOrOtherNode.getLength()>0)
					{

						flgCompanyProdOrOther=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}*/
				...
				dbengine.saveTblGetMRProuctBussinessMstr(WeightCategoryID,WeightCategory,BrandID,BrandName,CategoryID,CategoryName,Sequence);

				// dbengine.saveTblMRStoreProuctMapMstr(WeightCategoryID,WeightCategory,BrandID,BrandName,CategoryID,CategoryName,Sequence);

			}



			NodeList tblMRStoreProuctMapMstrNode = doc.getElementsByTagName("tblMRStoreProuctMapMstr");
			for (int i = 0; i < tblMRStoreProuctMapMstrNode.getLength(); i++)
			{
				...
				int WeightCategoryID=0;
				int flgCategory=0;
				String flgFloorStack="0";
				int BussinessUnitID=0;
				int flgActive=0;
				int flgCompanyProdOrOther=0;
				int Sequence=0;
				int lstStckCtgrySlf=0;


				Element element = (Element) tblMRStoreProuctMapMstrNode.item(i);
				...
				if(!element.getElementsByTagName("flgCategory").equals(null))
				{

					NodeList flgCategoryNode = element.getElementsByTagName("flgCategory");
					Element     line = (Element) flgCategoryNode.item(0);

					if(flgCategoryNode.getLength()>0)
					{

						flgCategory=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}

				if(!element.getElementsByTagName("flgFloorStack").equals(null))
				{

					NodeList flgFloorStackNode = element.getElementsByTagName("flgFloorStack");
					Element     line = (Element) flgFloorStackNode.item(0);

					if(flgFloorStackNode.getLength()>0)
					{

						flgFloorStack=xmlParser.getCharacterDataFromElement(line);
					}
				}
				...
				if(!element.getElementsByTagName("BusinessUnitId").equals(null))
				{
					...
					NodeList BussinessUnitIDNode = element.getElementsByTagName("BusinessUnitId");
					Element     line = (Element) BussinessUnitIDNode.item(0);
				...
				if(!element.getElementsByTagName("flgActive").equals(null))
				{
					...
					if(flgActiveNode.getLength()>0)
					{
						...
						flgActive=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}
				...
				if(!element.getElementsByTagName("LastStockCategorySelf").equals(null))
				{

					NodeList LastStockCategorySelfNode = element.getElementsByTagName("LastStockCategorySelf");
					Element     line = (Element) LastStockCategorySelfNode.item(0);

					if(LastStockCategorySelfNode.getLength()>0)
					{

						lstStckCtgrySlf=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}


				dbengine.saveTblMRStoreProuctMapMstr(StoreID,ProductID,WeightCategoryID,flgCategory,flgFloorStack,BussinessUnitID,flgActive,flgCompanyProdOrOther,Sequence,lstStckCtgrySlf);


				// dbengine.saveTblMRStoreProuctMapMstr(WeightCategoryID,WeightCategory,BrandID,BrandName,CategoryID,CategoryName,Sequence);

				//dbengine.saveTblGetMRProuctBussinessMstr(StoreID,ProductID,WeightCategoryID,flgCategory,flgFloorStack,BussinessUnitID,flgActive,flgCompanyProdOrOther,Sequence);
			}


			NodeList tblMRStoreCategoryMapMstrrNode = doc.getElementsByTagName("tblMRStoreCategoryMapMstr");
			for (int i = 0; i < tblMRStoreCategoryMapMstrrNode.getLength(); i++)
			{
				String StoreID="0";
				String BussinessUnitID="0";
				String BussinessUnitNodeType="0";
				String NoOfFloorStand="0";
				String displayCatId="2";

				Element element = (Element) tblMRStoreCategoryMapMstrrNode.item(i);
				if(!element.getElementsByTagName("StoreID").equals(null))
				{
					NodeList StoreIDNode = element.getElementsByTagName("StoreID");
					Element     line = (Element) StoreIDNode.item(0);
				...
				if(!element.getElementsByTagName("BusinessUnitNodeID").equals(null))
				{
					NodeList BussinessUnitIDNode = element.getElementsByTagName("BusinessUnitNodeID");
					Element     line = (Element) BussinessUnitIDNode.item(0);
					if(BussinessUnitIDNode.getLength()>0)
					{
						BussinessUnitID=xmlParser.getCharacterDataFromElement(line);
					}
				}

				if(!element.getElementsByTagName("NoOfFloorStand").equals(null))
				{

					NodeList NoOfFloorStandNode = element.getElementsByTagName("NoOfFloorStand");
					Element     line = (Element) NoOfFloorStandNode.item(0);

					if(NoOfFloorStandNode.getLength()>0)
					{
						NoOfFloorStand=xmlParser.getCharacterDataFromElement(line);
					}
				}
				if(!element.getElementsByTagName("BusinessUnitNodeType").equals(null))
				{
					NodeList BussinessUnitNodeTypeDNode = element.getElementsByTagName("BusinessUnitNodeType");
					Element     line = (Element) BussinessUnitNodeTypeDNode.item(0);
					if(BussinessUnitNodeTypeDNode.getLength()>0)
					{
						BussinessUnitNodeType=xmlParser.getCharacterDataFromElement(line);
					}
				}

				dbengine.savetblNoOfFloorStcks(StoreID, BussinessUnitID, displayCatId,
						NoOfFloorStand,BussinessUnitNodeType,1);
				//  dbengine.savetblMRStoreCategoryMapMstr(StoreID,BussinessUnitID,NoOfFloorStand);
			}




			NodeList tblMRStoreAdditionalDisplayDetailsNode = doc.getElementsByTagName("tblMRStoreAdditionalDisplayDetails");
			for (int i = 0; i < tblMRStoreAdditionalDisplayDetailsNode.getLength(); i++)
			{
				int RowID=0;
				int CategoryID=0;
				int ProductID=0;
				...
				Element element = (Element) tblMRStoreAdditionalDisplayDetailsNode.item(i);
				if(!element.getElementsByTagName("RowID").equals(null))
				{
					NodeList RowIDNode = element.getElementsByTagName("RowID");
					Element  line = (Element) RowIDNode.item(0);
				...
				if(!element.getElementsByTagName("LastStockOn").equals(null))
				{
					NodeList LastStockOnNode = element.getElementsByTagName("LastStockOn");
					Element     line = (Element) LastStockOnNode.item(0);

					if(LastStockOnNode.getLength()>0)
					{
						lastStock=xmlParser.getCharacterDataFromElement(line);
					}
				}


				dbengine.savetblMRStoreAdditionalDisplayDetails(RowID,CategoryID,ProductID,flgCompanyProdOrOther,Sequence,lastStock);

			}

			NodeList tblMRStoreFloorStackLastStockNode = doc.getElementsByTagName("tblMRStoreFloorStackLastStock");
			for (int i = 0; i < tblMRStoreFloorStackLastStockNode.getLength(); i++)
			{
				String StoreId="0";
				String BusinessUnitNodeId="0";
				String BusinessUnitNodeType="0";
				String productId="0";
				int lastStock=0;
				String floorStackSequence="0";

				Element element = (Element) tblMRStoreFloorStackLastStockNode.item(i);
				if(!element.getElementsByTagName("StoreID").equals(null))
				{
					NodeList StoreIDNode = element.getElementsByTagName("StoreID");
					Element  line = (Element) StoreIDNode.item(0);
				...
				if(!element.getElementsByTagName("BusinessUnitNodeID").equals(null))
				{
					NodeList BusinessUnitNodeIDNode = element.getElementsByTagName("BusinessUnitNodeID");
					Element     line = (Element) BusinessUnitNodeIDNode.item(0);

					if(BusinessUnitNodeIDNode.getLength()>0)
					{
						BusinessUnitNodeId=xmlParser.getCharacterDataFromElement(line);
					}
				}
				...
				if(!element.getElementsByTagName("LastStock").equals(null))
				{
					NodeList LastStockNode = element.getElementsByTagName("LastStock");
					Element     line = (Element) LastStockNode.item(0);

					if(LastStockNode.getLength()>0)
					{
						lastStock=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}
				if(!element.getElementsByTagName("FloorStackSequence").equals(null))
				{
					NodeList FloorStackSequenceNode = element.getElementsByTagName("FloorStackSequence");
					Element     line = (Element) FloorStackSequenceNode.item(0);

					if(FloorStackSequenceNode.getLength()>0)
					{
						floorStackSequence=xmlParser.getCharacterDataFromElement(line);
					}
				}

				dbengine.fnSavetblMRStoreFloorStackLstStock(StoreId,BusinessUnitNodeId,BusinessUnitNodeType,productId,lastStock,floorStackSequence);

			}

			NodeList tblWareHouseLastStockNode = doc.getElementsByTagName("tblWareHouseLastStock");
			for (int i = 0; i < tblWareHouseLastStockNode.getLength(); i++)
			{
				String StoreId="0";
				String productID="0";
				String wareHouseLastStock="0";


				Element element = (Element) tblWareHouseLastStockNode.item(i);
				if(!element.getElementsByTagName("StoreID").equals(null))
				{
					NodeList StoreIDNode = element.getElementsByTagName("StoreID");
					Element  line = (Element) StoreIDNode.item(0);
				...
				if(!element.getElementsByTagName("WareHouseLastStock").equals(null))
				{
					NodeList WareHouseLastStockNode = element.getElementsByTagName("WareHouseLastStock");
					Element     line = (Element) WareHouseLastStockNode.item(0);

					if(WareHouseLastStockNode.getLength()>0)
					{
						wareHouseLastStock=xmlParser.getCharacterDataFromElement(line);
					}
				}



				dbengine.fnSavetblWareHouseLstStock(StoreId,productID,wareHouseLastStock);

			}

			/*NodeList tblMRStoreAdditionalDisplayMstrNode = doc.getElementsByTagName("tblMRStoreAdditionalDisplayMstr");
			for (int i = 0; i < tblMRStoreAdditionalDisplayMstrNode.getLength(); i++)
			{
				int RowID=0;
				int StoreID=0;
				int AdditionalDisplayTypeID=0;
				int LocatinoID=0;
				int BusinessUnitID=0;

				Element element = (Element) tblMRStoreAdditionalDisplayMstrNode.item(i);
				if(!element.getElementsByTagName("RowID").equals(null))
				{
					NodeList RowIDNode = element.getElementsByTagName("RowID");
					Element  line = (Element) RowIDNode.item(0);
				...
				if(!element.getElementsByTagName("StoreID").equals(null))
				{
					...
					if(StoreIDNode.getLength()>0)
					{
						StoreID=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}

				if(!element.getElementsByTagName("AdditionalDisplayTypeID").equals(null))
				{

					NodeList AdditionalDisplayTypeIDNode = element.getElementsByTagName("AdditionalDisplayTypeID");
					Element     line = (Element) AdditionalDisplayTypeIDNode.item(0);

					if(AdditionalDisplayTypeIDNode.getLength()>0)
					{
						AdditionalDisplayTypeID=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}

				if(!element.getElementsByTagName("LocatinoID").equals(null))
				{
					NodeList LocatinoIDNode = element.getElementsByTagName("LocatinoID");
					Element     line = (Element) LocatinoIDNode.item(0);
					if(LocatinoIDNode.getLength()>0)
					{
						LocatinoID=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
					}
				}
				...
				dbengine.savetblMRStoreAdditionalDisplayMstr(RowID,StoreID,AdditionalDisplayTypeID,LocatinoID,BusinessUnitID);
			}*/
	       ...
	       // // System.out.println("Kajol 3 :"+name);
	        ...
	        DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
	            ...
	            for (int i = 0; i < tblSchemeStoreMappingNode.getLength(); i++)
	            {
	                ...
	                // System.out.println("Kajol tblUserAuthentication StoreID: " +flgUserAuthenticated );
					NodeList flgAllRoutesDataNode = element.getElementsByTagName("flgToShowAllRoutesData");
					Element line1 = (Element) flgAllRoutesDataNode.item(0);
					flgAllRoutesData=Integer.parseInt(xmlParser.getCharacterDataFromElement(line1));
					...
					dbengine.savetblUserAuthenticationMstr(flgUserAuthenticated,flgAllRoutesData,flgAppStatus,DisplayMessage);
...
String RouteType="0";
	...
	public ServiceWorker getAllNewSchemeStructure(Context ctx,String dateVAL, String uuid, String rID) 
	{
		this.context = ctx;
		DBAdapterKenya dbengine = new DBAdapterKenya(context);
		 dbengine.open();
...
//return counts;
	...
	public ServiceWorker getallProduct(Context ctx, String dateVAL, String uuid, String rID) 
	{
		...
		final String SOAP_ACTION = "http://tempuri.org/GetMRProductListFromFinalDB";//GetProductListMRNewProductFilterTest";
		final String METHOD_NAME = "GetMRProductListFromFinalDB";//GetProductListMRNewProductFilterTest
		final String NAMESPACE = "http://tempuri.org/";
		final String URL = UrlForWebService;
		...
		try {
			...
			try
			{
				...
				System.out.println("hi"+RouteNodeType);
			}
			catch(Exception e)
			{
				System.out.println("error"+e);
			...
			dbengine.Delete_tblProductList_for_refreshData();
					...
					{	
						...
						String businessUnitId="0";
						String businessUnitNodeType="0";
						int CompanyCompetitorProduct=0;
						String weightCatId="0";
						...
						if(!element.getElementsByTagName("CompanyCompetitorProduct").equals(null))
					{

						NodeList CompanyCompetitorProductNode = element.getElementsByTagName("CompanyCompetitorProduct");
						Element     line = (Element) CompanyCompetitorProductNode.item(0);

						if(CompanyCompetitorProductNode.getLength()>0)
						{

							CompanyCompetitorProduct=Integer.parseInt(xmlParser.getCharacterDataFromElement(line));
							if(CompanyCompetitorProduct==2)
							{
								String asd="abhinav";
							}
						...
						if(!element.getElementsByTagName("WeightCategoryID").equals(null))
						{
							...
							if(WeightCategoryIDNode.getLength()>0)
							{
								...
								weightCatId=xmlParser.getCharacterDataFromElement(line);
						...
						//CompanyCompetitorProduct
						//SearchField	
						dbengine.saveSOAPdataProductList(businessUnitId,businessUnitNodeType,CatID,ProductID,ProductShortName,DisplayUnit,CalculateKilo,KGLiter,CatOrdr,PrdOrdr,StoreCatNodeId,SearchField,ManufacturerID,CompanyCompetitorProduct,weightCatId);
...
//return counts;
	...
	public ServiceWorker getallPDASchAppListForSecondPage(Context ctx, String dateVAL,String uuid, String rID)
	{
		this.context = ctx;
...
//return counts;
	...
	public ServiceWorker GetPDAIsSchemeApplicable(Context ctx, String dateVAL, String uuid, String rID) {
		this.context = ctx;
...
//return counts;
	...
	public ServiceWorker GetLODDetailsOnLastSalesSummary(Context ctx, String dateVAL, String uuid, String rID) 
	{
		this.context = ctx;
...
//return counts;
	...
	public ServiceWorker GetCallspForPDAGetLastVisitDate(Context ctx, String dateVAL, String uuid, String rID) 
	{
		this.context = ctx;
...
//return counts;
	...
	public ServiceWorker GetCallspForPDAGetLastOrderDate(Context ctx, String dateVAL, String uuid, String rID)
	{
		this.context = ctx;
...
//return counts;
	...
	public ServiceWorker GetCallspForPDAGetLastVisitDetails(Context ctx, String dateVAL, String uuid, String rID) 
	{
		this.context = ctx;
...
//return counts;
	...
	public ServiceWorker GetCallspForPDAGetLastOrderDetails(Context ctx, String dateVAL, String uuid, String rID) {
		this.context = ctx;
...
//return counts;
	...
	public ServiceWorker GetCallspForPDAGetLastOrderDetails_TotalValues(Context ctx, String dateVAL, String uuid, String rID)
	{
		this.context = ctx;
...
//return counts;
	...
	public ServiceWorker GetCallspForPDAGetExecutionSummary(Context ctx, String dateVAL, String uuid, String rID) 
	{
		this.context = ctx;
...
//tblValueVolumeTarget
	...
	public ServiceWorker getfnGetStoreWiseTarget(Context ctx, String dateVAL, String uuid, String rID)
	{
		this.context = ctx;
...
//nitika
	...
	//brand elements
	public ServiceWorker getBrandingElementsMstrData(Context ctx, String dateVAL, String uuid, String rID)
	{
		this.context = ctx;
		DBAdapterKenya dbengine = new DBAdapterKenya(context);
		String RouteType="0";
		...
		final String SOAP_ACTION = "http://tempuri.org/fnGetPDABrandingElement";
		final String METHOD_NAME = "fnGetPDABrandingElement";
		final String NAMESPACE = "http://tempuri.org/";
		final String URL = UrlForWebService;
		...
		try
		{
			...
			dbengine.open();
			dbengine.deletetblBrandingElementMstr();

			NodeList tblBrandingElementMstrNode = doc.getElementsByTagName("tblBrandingElementMstr");
			for (int i = 0; i < tblBrandingElementMstrNode.getLength(); i++)
			{
				String BrandElementID="0";
				String BrandElementDescr="0";

				Element element = (Element) tblBrandingElementMstrNode.item(i);

				if(!element.getElementsByTagName("BrandElementID").equals(null))
				{
					NodeList BrandElementIDNode = element.getElementsByTagName("BrandElementID");
					Element  line = (Element) BrandElementIDNode.item(0);

					if(BrandElementIDNode.getLength()>0)
					{
						BrandElementID=xmlParser.getCharacterDataFromElement(line);
					}
				}

				if(!element.getElementsByTagName("BrandElementDescr").equals(null))
				{
					NodeList BrandElementDescNode = element.getElementsByTagName("BrandElementDescr");
					Element line = (Element) BrandElementDescNode.item(0);

					if(BrandElementDescNode.getLength()>0)
					{
						BrandElementDescr=xmlParser.getCharacterDataFromElement(line);
					}
				}

				dbengine.savetblBrandingElementMstr(BrandElementID,BrandElementDescr);
				System.out.println("BRAND..."+BrandElementID+"-"+BrandElementDescr);
			}

			setmovie.director = "1";
			flagExecutedServiceSuccesfully=10;
			dbengine.close();
			return setmovie;
