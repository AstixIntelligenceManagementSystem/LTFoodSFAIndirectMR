...
public class LastVisitDetailsSecondPart extends Activity
{
	...
	public void setUpVariable()
	{
		 TextView StoreName = (TextView)findViewById(R.id.StoreName);
			...
			dbengine.close();
			StoreName.setText(selStoreName+" "+"Summary");
	...
	public void setUpTablesData()
	{
		...
		if(checkDataForVisitDetails==1)
		{
			...
			ExecutedDate.setText("Executed("+LastVisitDateForTable[0]+")");
		...
		if(checkDataForOrderDetails==1)
		{
			...
			if(LastVisitDateForTable[0].equals(LastOrderDateForTable[0]))
			{
				...
				LastVisitHeading.setText("Last Visit/Order Details");
			...
			ExecutedDateOrder.setText("Executed("+LastOrderDateForTable[0]+")");
