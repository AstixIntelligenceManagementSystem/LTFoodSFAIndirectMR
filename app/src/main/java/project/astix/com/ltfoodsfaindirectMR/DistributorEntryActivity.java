	...
	private class FullSyncDataNow extends AsyncTask<Void, Void, Void> 
	{
		...
		protected Void doInBackground(Void... params)
		{
			...
			try {
				 ...
				 File MeijiDistributorEntryXMLFolder = new File(Environment.getExternalStorageDirectory(), "MeijiDistributorEntryXML");
		...
		@Override
		 protected void onPreExecute() 
		  {
			 ...
			 File MeijiIndirectSFAxmlFolder = new File(Environment.getExternalStorageDirectory(), "MeijiDistributorEntryXML");
	        ...
	        protected Integer doInBackground(Void... params) 
		 {
			 ...
			 // Sending only one xml at a times
			    ...
			    File del = new File(Environment.getExternalStorageDirectory(), "MeijiDistributorEntryXML");
