...
public class Delivery_Details_New_Activity extends Activity implements  DatePickerDialog.OnDateSetListener,TimePickerDialog.OnTimeSetListener{
	...
	Button Done_btn;
	 AlertDialog ad;
	 View convertView;
	TextView Delivery_Location_Spinner,changeRequiredTextview;
	EditText Delivery_Address_other_selection;
	...
	LinearLayout MainlayoutParentOfWholePage;
	  ...
	  RadioButton rb_occasionally,rb_Permanent;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.delivery__details__new_activity);
		...
		initializeRadioButton();
		  Delivery_Address_other_selection=(EditText) findViewById(R.id.Delivery_Address_other_selection);
	...
	public void fillAllDataOfDeliverySectionToView() {
		...
		if(helperDb.checkStoreOrderBillAddressDetails(storeID, OrderPDAID)==1)
		{
			...
			if(string_Delivery_Location_Spinner.equals("-99")){

				String otherSelectionInfo=	helperDb.fnGetDeliveryOtherInfo(storeID, OrderPDAID);

					if(string_Delivery_Location_Spinner.equals("-99") && !otherSelectionInfo.equals("NA")){
						String OtherAddressDataBase=otherSelectionInfo.split(Pattern.quote("$"))[0];
						String permanentFlgDataBase=otherSelectionInfo.split(Pattern.quote("$"))[1];
						String occasiaonallyFlgDataBase=otherSelectionInfo.split(Pattern.quote("$"))[2];
						Delivery_Location_Address.setText("");
						Delivery_Location_Address.setVisibility(View.GONE);
						Delivery_Address_other_selection.setVisibility(View.VISIBLE);
						Delivery_Address_other_selection.setText(OtherAddressDataBase);

						rb_Permanent.setVisibility(View.VISIBLE);
						if(permanentFlgDataBase.equals("1")){
							rb_Permanent.setChecked(true);
						}
						rb_occasionally.setVisibility(View.VISIBLE);
						if(occasiaonallyFlgDataBase.equals("1")){
							rb_occasionally.setChecked(true);

						}
						changeRequiredTextview.setVisibility(View.VISIBLE);
					}
			...
			public void onClick(View arg0) {
				if(validateDelivery_Location_Spinner())
				{
					AlertDialog.Builder alertDialog = new AlertDialog.Builder(
							Delivery_Details_New_Activity.this);
					...
					alertDialog.setPositiveButton("Yes",
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
										int which) {
									dialog.dismiss();
									Intent fireBackDetPg=new Intent(Delivery_Details_New_Activity.this,OrderReview.class);
	...
	public void initializeDropdown() {
		changeRequiredTextview=(TextView) findViewById(R.id.changeRequiredTextview);
		   ...
		   Delivery_Location_Spinner.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if(!hmapStoreShippToAddress.equals(null) && !hmapStoreShippToAddress.isEmpty()){
					AlertDialog.Builder	 alertDialog = new AlertDialog.Builder(Delivery_Details_New_Activity.this);
					 ...
					 EditText inputSearch=	 (EditText) convertView.findViewById(R.id.inputSearch);
					  ...
					  int index=0;
						if(hmapStoreShippToAddress!=null)
				    	{
						 ...
						 adapterDeliveryAddress = new ArrayAdapter<String>(Delivery_Details_New_Activity.this, R.layout.list_item, R.id.product_name, DeliverAddresstList);
					        ...
					        listDeliveryLocation.setOnItemClickListener(new OnItemClickListener() {
								...
								public void onItemClick(AdapterView<?> arg0, View arg1,
									...
									if(abc.equals("Select")){
										Delivery_Location_Spinner.setText("Select");
										Delivery_Location_Address.setText("");
										Delivery_Location_Address.setVisibility(View.VISIBLE);
										Delivery_Address_other_selection.setVisibility(View.GONE);
										rb_Permanent.setVisibility(View.GONE);
										rb_Permanent.setChecked(false);
										rb_occasionally.setVisibility(View.GONE);
										rb_occasionally.setChecked(false);
										changeRequiredTextview.setVisibility(View.GONE);
										}
									else{
										
										if(hmapStoreShippToAddress.get(abc).equals("-99")){
											Delivery_Location_Address.setText("");
											Delivery_Location_Address.setVisibility(View.GONE);
											Delivery_Address_other_selection.setText("");
											Delivery_Address_other_selection.setVisibility(View.VISIBLE);
											rb_Permanent.setVisibility(View.VISIBLE);
											rb_occasionally.setVisibility(View.VISIBLE);
											changeRequiredTextview.setVisibility(View.VISIBLE);
					 ...
					 EditText inputSearch=	 (EditText) convertView.findViewById(R.id.inputSearch);
					  ...
					  int index=0;
						if(hmapStoreBillTogAddresse!=null)
				    	{
						 ...
						 adapterBillingAddress = new ArrayAdapter<String>(Delivery_Details_New_Activity.this, R.layout.list_item, R.id.product_name, BillingAdressList);
	 ...
	 public boolean validatecheckboxofDelivery() {
		...
		String fullstring="0";
			String otherAddress="NA";
			String permanentCheck="NA";
			String occasionallyCheck="NA";
		...
		if(!biltocustomernameSpinner.getText().toString().trim().equals("Select")){
			...
			if(hmapStoreShippToAddress.get(Delivery_Location_Spinner.getText().toString()).equals("-99")){
				otherAddress=Delivery_Address_other_selection.getText().toString();

				if(rb_Permanent.isChecked()){
					permanentCheck="1";
					occasionallyCheck="0";
				}
				if(rb_occasionally.isChecked()){
					occasionallyCheck="1";
					permanentCheck="0";
		...
		helperDb.open();
		helperDb.fnsaveStoreOrderBillAddressDetails(storeID, OrderPDAID, string_biltocustomernameSpinner, string_Delivery_Location_Spinner+"^"+string_Delivery_Time_From+"^"+string_Delivery_Time_To+"^"+string_DoNotDeliverTime_From+"^"+string_DoNotDeliverTime_To+"^"+string_RequiredDeliveryDate, "1",otherAddress,permanentCheck,occasionallyCheck);
		helperDb.close();
	...
	public void timeSelection() {
		...
		CalenderValTo.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				datePickerDialog = DatePickerDialog.newInstance(
						Delivery_Details_New_Activity.this, Year, Month, Day);
	 ...
	 {
	 		AlertDialog.Builder alertDialogNoConn = new AlertDialog.Builder(Delivery_Details_New_Activity.this);
	...
	public boolean validateDelivery_Location_Spinner()
	{
		...
		if(helperDb.checkIfCurrentStoreIsNewInOrderBill(storeID)==0)
		{
			...
			else if(hmapStoreShippToAddress!=null && !hmapStoreShippToAddress.isEmpty() && hmapStoreShippToAddress.get(Delivery_Location_Spinner.getText().toString()).equals("-99") && Delivery_Address_other_selection.getText().toString().equals("") )
			{
				alertError("Please Provide DeliveryLocation");
			}
			else if( hmapStoreShippToAddress.get(Delivery_Location_Spinner.getText().toString()).equals("-99")  && !rb_Permanent.isChecked() && !rb_occasionally.isChecked())
			{
				alertError("Please Select Change Required");
			}
			else
			{
	...
	public void alertError(String msg)
	{
		AlertDialog alertDialog = new AlertDialog.Builder(
				Delivery_Details_New_Activity.this).create();
...
alertDialog.show();
	...
	public void initializeRadioButton() {
		rb_Permanent=(RadioButton) findViewById(R.id.rb_Permanent);
		
		rb_Permanent.setOnClickListener(new OnClickListener() {
		...
		rb_occasionally=(RadioButton) findViewById(R.id.rb_occasionally);
		rb_occasionally.setOnClickListener(new OnClickListener() {
